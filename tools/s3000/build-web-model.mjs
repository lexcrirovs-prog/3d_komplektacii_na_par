...
const report = { version: '2026.09.09.3', date: '2026-09-09', executor: 'Codex / GPT-6 Astra', status: 'PASSED_DERIVATIVE_STRUCTURE', sourceSha256: originalHash, outputSha256: sha(await readFile(target)), beforeBytes: (await stat(source)).size, afterBytes: (await stat(target)).size,
