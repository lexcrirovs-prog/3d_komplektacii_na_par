...
Последняя CAD- и Blender-редакция: **S-4000 «Комфорт», 8–12 бар, 2026.09.10.5 от 10.09.2026**. Исполнитель: **Codex / GPT-6 Astra**. Исправлена форма отвода группы давления: замкнутая O-петля заменена открытым изгибом, приборы котла сохранены, три кабеля закреплены вдоль трубы. Сохраняются открывающиеся двери и разворот деаэратора на 180°. Подробная геометрия передана в AutoCAD без упрощения.

| Вариант | Версия | Описание |
|---|---|---|
| S-4000 AutoCAD | 2026.09.10.5 | [Исправленный отвод и проверка](docs/releases/s4000-autocad-v2026.09.10.5/README.md), [открыть и управлять](docs/s4000-autocad-opening-guide-20260910.md) |
| S-4000 Blender | 2026.09.10.5 | [Исправление группы давления](docs/releases/s4000-blender-v2026.09.10.5/README.md) |
