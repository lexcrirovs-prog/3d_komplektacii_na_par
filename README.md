...
Последняя версия в этой ветке: **2026.09.08.3 от 8 сентября 2026 года**. Исполнитель: **Codex / GPT-6 Astra**. Версия npm: `2026.9.8-3`.
...
![Боковой коллектор и датчики](docs/previews/s3000-level-detail.png)

![ДА-25 с оцинкованной обшивкой](docs/previews/s3000-deaerator-detail.png)
...
Указатели уровня RLG-16, арматура АДЛ, насосы Jetex и шкаф построены параметрически с опорой на фотографии. Фотографии относятся к S-4000; количество и наименования оборудования относятся к S-3000. Трассы обвязки и размеры деталей, восстановленных по фото, требуют проверки по монтажным чертежам. Выбор модели горелки для мощности S-3000 не подтверждён расчётом. Эта поставка предназначена для визуального согласования. Инженерная приёмка и подготовка STL для печати не выполнены.
...
- [Результаты версии 3](docs/s3000-detail-verification-20260908.json).
