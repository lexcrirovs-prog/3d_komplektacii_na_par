...
Последняя CAD-редакция: **S-4000 «Комфорт», 8–12 бар, 2026.09.10.4 от 10.09.2026**. Исполнитель: **Codex / GPT-6 Astra**. В AutoCAD перенесён вариант Blender с деаэратором, развёрнутым на 180°, открывающимися дверями котла и шкафа. Подробная геометрия сохранена без уменьшения числа полигонов.

| Вариант | Версия | Описание |
|---|---|---|
| S-4000 AutoCAD | 2026.09.10.4 | [Выпуск и проверка](docs/releases/s4000-autocad-v2026.09.10.4/README.md), [открыть и управлять](docs/s4000-autocad-opening-guide-20260910.md) |
| S-4000 Blender | 2026.09.10.3 | [Двери и разворот деаэратора](docs/releases/s4000-blender-v2026.09.10.3/README.md) |
