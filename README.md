...
Последняя версия в этой ветке: **2026.09.09.5 от 9 сентября 2026 года**. Исполнитель: **Codex / GPT-6 Astra**. Версия npm: `2026.9.9-5`. Выровнен корпус правого нижнего контроллера шкафа. Нижняя подводка закреплена на двери и уложена с прямыми участками. [Описание исправления](docs/s3000-cabinet-20260909.md).

Веб-задача приняла эту поставку и независимо проверила основной адрес 9 сентября 2026 года. Проверяющий — **Codex / GPT-6**. Все 24 публичных файла совпали, 12 сценариев дверей и шкафа прошли. Контрольный замер: первый / повторный вход — 9,03 / 0,68 с при 10 Мбит/с; 17,03 / 0,91 с при 4 Мбит/с на мобильном размере экрана. Вращение — около 71 кадра/с на тестовом компьютере. [Приёмка и ограничения измерений](docs/s3000-web-handoff-20260909.md). Оптимизированная версия уже находилась на сайте; повторная публикация одинаковых файлов не выполнялась.
