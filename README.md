...
Последняя CAD- и Blender-редакция: **S-4000 «Комфорт», 8–12 бар, 2026.09.11.1 от 11.09.2026**. Исполнитель: **Codex / GPT-6 Astra**. FV8 установлен на пол, ДА-15 поднят ровно на 1 м с опорой под обеими сёдлами. Добавлен конденсатоотводчик **Стимакс А31 DN25 Ф/Ф** из предоставленного DWG; его фланцы соединены с FV8 и BDV. Двери и переключаемая обвязка сохранены. [Отметки, выбор А31 и ограничения](docs/s4000-floor-layout-20260911.md).
