...
Текущая редакция: **S-4000 «Комфорт», 8–12 бар, 2026.09.11.1 от 11.09.2026**, исправление по видео в существующих файлах. Исполнитель: **Codex / GPT-6 Astra**. В Blender и DXF исправлены ориентация А31 и привода продувки, кабели, отвод приборного коллектора, датчики, отбор пробы и сбросы. Модуляция перенесена после экономайзера, а клапан FV — на подтверждённый малый DN25. Отметки FV=0, ДА=+1 м, двери и проставка 500 мм сохранены. [Подробные поправки](docs/s4000-floor-layout-20260911.md).

**Состояние поправки:** Blender сохранён и проверен. Геометрия и команды обновлённого DXF проверены в AutoCAD. Окончательное обновление и повторное чтение двух DWG ожидают разовой загрузки команды владельцем в окне AutoCAD «Security — Unsigned Executable File». Прежний архив AutoCAD ещё не пересобран; результаты до видео отделены от текущих проверок. [Статус AutoCAD](docs/releases/s4000-autocad-v2026.09.11.1/README.md).
