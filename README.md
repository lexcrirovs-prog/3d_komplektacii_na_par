...
Последняя CAD- и Blender-редакция: **S-4000 «Комфорт», 8–12 бар, 2026.09.10.6 от 10.09.2026**. Исполнитель: **Codex / GPT-6 Astra**. Обвязка проверена по предоставленной тепловой схеме: непрерывная продувка направлена в FV8, периодическая — в BDV, исправлен ручной обход нижней продувки, добавлены сливы и отводы. Отсутствующие устройства обозначены разрывами; состав «Комфорт+» не перенесён. Сохраняются открывающиеся двери, отвод группы давления и разворот ДА-15 на 180°. [Полное сопоставление трубопроводов](docs/s4000-piping-audit-20260910.md).

| Вариант | Версия | Описание |
|---|---|---|
| S-4000 AutoCAD | 2026.09.10.6 | [Обвязка FV8 и BDV](docs/releases/s4000-autocad-v2026.09.10.6/README.md), [открыть и управлять](docs/s4000-autocad-opening-guide-20260910.md) |
| S-4000 Blender | 2026.09.10.6 | [Обвязка и проверка](docs/releases/s4000-blender-v2026.09.10.6/README.md) |
