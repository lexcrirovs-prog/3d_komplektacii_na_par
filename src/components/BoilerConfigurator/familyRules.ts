export const powers = [500,1000,1500,2000,2500,3000,4000,5000] as const
...
export function familyFor(power:number) { return power<=1500?'small':power<=3000?'medium':'large' }
