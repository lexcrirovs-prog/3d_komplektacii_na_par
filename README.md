...
Последняя поправка от **11.09.2026**: проводка уложена в **закрытые оцинкованные кабель-каналы** с крышками и креплениями. Каналы соединяют приборную группу, датчики уровня, оба насоса и выбранные приводы с нижним вводом шкафа. На дверце шкафа длинные участки проводов закрыты четырьмя каналами; гибкий переход у петли сохранён для открывания. У разъёмов оставлены короткие подводы. Исполнитель — **Codex / GPT-6 Astra**.
