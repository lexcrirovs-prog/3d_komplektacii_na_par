...
Последняя версия в этой ветке: **2026.09.08.4 от 8 сентября 2026 года**. Исполнитель: **Codex / GPT-6 Astra**. Версия npm: `2026.9.8-4`.

Для этой геометрии подготовлен отдельный **экспорт AutoCAD 2026.09.09.1 от 9 сентября 2026 года**, исполнитель **Codex / GPT-6 Astra**. Два DWG/DXF содержат подробную цветную сборку с экономайзером либо с прямой подачей воды. Оборудование разделено на блоки и слои, масштаб - миллиметры. [Использование и проверка CAD-файлов](docs/S3000-AUTOCAD.md). Номер версии сайта остаётся прежним.

**Опубликовано 9 сентября 2026 года: [prgz.ru/komplektacii4](https://prgz.ru/komplektacii4/).** Страница работает на хостинге и не требует запущенного локального просмотрщика. На сервер передана проверенная сборка из коммита `023cac3`. [Протокол публикации](docs/s3000-publication-20260909.json).
