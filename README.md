...
**Очистка диска от 12.09.2026:** сохранены последние комплекты S-3000 **2026.09.09.5** и S-4000 **2026.09.11.1** для AutoCAD и Blender. Удалены 3 922 старых и промежуточных файла — **6,96 ГиБ**. Повторно проверены 1 080 сохраняемых файлов; геометрия не менялась. Исполнитель: **Codex / GPT-6 Astra**. [Актуальные чертежи и протокол очистки](docs/latest-drawings-20260911.md).
