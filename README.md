# PREMIUM — 3D-сборки котлов

Веб-конфигуратор в этой ветке: **2026.09.13.1 от 13.09.2026 · Codex / GPT-6**.
Опубликована и проверена на [prgz.ru/komplektacii4](https://prgz.ru/komplektacii4/).
Тестовая линейка: **500, 1000, 1500, 2000, 2500, 3000, 4000, 5000 кг/ч**.
Три исходные модели — S-1000 с вертикальным ДА-3, S-3000 и S-4000.
Все мощности поддерживают «Стандарт», «Комфорт», «Комфорт+», независимые
BDV/FV. Модуляция доступна в «Комфорт» и «Комфорт+». Электропривод ГПЗ
опционален ниже 4000 кг/ч, обязателен от 4000 включительно.
У моделей 500–3000 кг/ч проставка экономайзера сокращена до 500 мм.
Во всех группах датчики подключены по закреплённым трассам в защитных рукавах,
с отдельными нижними вводами шкафа. Визуализация не заменяет электрическую схему.
[Протокол текущего выпуска](docs/releases/boiler-family-v2026.09.13.1/README.md).
Инженерные исходники ниже сохраняют собственную дату и версию.

Текущая редакция: **S-4000 «Комфорт», 8–12 бар, 2026.09.11.1 от 11.09.2026**, исправление по видео в существующих файлах. Исполнитель: **Codex / GPT-6 Astra**. В Blender, DXF и двух DWG исправлены ориентация А31 и привода продувки, кабели, отвод приборного коллектора, датчики, отбор пробы и сбросы. Модуляция перенесена после экономайзера, а клапан FV — на подтверждённый малый DN25. Отметки FV=0, ДА=+1 м, двери и проставка 500 мм сохранены. [Подробные поправки](docs/s4000-floor-layout-20260911.md).
...
**Состояние поправки:** Blender и оба DWG сохранены и проверены. Вылеты сбросных труб поменяны местами: прямые участки параллельны и не пересекаются. Оба DWG независимо открыты повторно; проверены 105 блоков, 20 сочетаний оборудования и девять состояний дверей. Существующие архивы обновлены. [Протокол и контрольные суммы AutoCAD](docs/releases/s4000-autocad-v2026.09.11.1/README.md).

| Вариант | Версия | Описание |
|---|---|---|
| S-4000 AutoCAD | 2026.09.11.1 | [Последний выпуск](docs/releases/s4000-autocad-v2026.09.11.1/README.md), [открыть и управлять](docs/s4000-autocad-opening-guide-20260910.md) |
| S-4000 Blender | 2026.09.11.1 | [Последний выпуск и виды](docs/releases/s4000-blender-v2026.09.11.1/README.md) |
| S-3000 AutoCAD / Blender | 2026.09.09.5 | [Последние чертежи и очистка старых выпусков](docs/latest-drawings-20260911.md) |
| S-3000, код сайта в этой ветке | 2026.09.09.5 | [Исправление приборов шкафа](docs/s3000-cabinet-20260909.md) |

## PREMIUM S-3000 — 3D-сборка АДЛ

Версия кода сайта S-3000 в этой ветке: **2026.09.09.5 от 9 сентября 2026 года**. Исполнитель: **Codex / GPT-6 Astra**. Версия npm: `2026.9.9-5`. Выровнен корпус правого нижнего контроллера шкафа. Нижняя подводка закреплена на двери и уложена с прямыми участками. [Описание исправления](docs/s3000-cabinet-20260909.md).
...
Веб-сетка версии 2026.09.09.5 содержит **1 277 077 треугольников**, подробная модель — 3 277 745. После разделения дверей и добавления внутренностей в сборке 54 компонента, 27 карточек оборудования. Обе схемы питания, горелка и деаэратор сохранены. Четыре GLB суммарно **11 551 412 байт**, каждый меньше 6 МБ. Модели повторно используются из кеша. Тени обновляются при движении дверей и смене комплектации. После остановки отрисовка прекращается.
