...
Веб-конфигуратор в этой ветке: **2026.09.12.1 от 12.09.2026 · Codex / GPT-6**.
Опубликована и проверена на [prgz.ru/komplektacii4](https://prgz.ru/komplektacii4/).
S-4000 представляет группу 4000–5000 кг/ч. Добавлены «Стандарт», «Комфорт»,
«Комфорт+», независимые BDV/FV, опция модуляции и обязательный электропривод
ГПЗ. Статус публикации, проверок и оставшейся интеграции младших групп:
[протокол выпуска](docs/releases/boiler-family-v2026.09.12.1/README.md).
