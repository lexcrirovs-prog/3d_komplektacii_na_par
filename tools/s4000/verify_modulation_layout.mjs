...
const root='E:/CodexArtifacts/Boiler-Family-v2026.09.13.6',results=[];
...
await mkdir('artifacts/modulation-geometry',{recursive:true});await writeFile('artifacts/modulation-geometry/report.json',JSON.stringify({status:'PASSED_SINGLE_ELBOW',version:'2026.09.13.6',results},null,2));
